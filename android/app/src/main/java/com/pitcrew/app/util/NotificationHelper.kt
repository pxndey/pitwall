...
object NotificationHelper {
    ...
    private const val CHANNEL_ID = "pitcrew_races"
    ...
    fun scheduleRaceNotifications(context: Context, race: JolpicaRace) {
        ...
        for (session in sessions) {
            ...
            val tag = "pitcrew-$round-${session.name}"
    ...
    fun cancelAll(context: Context) {
        WorkManager.getInstance(context).cancelAllWorkByTag("pitcrew-notification")
    }
}
...
class RaceNotificationWorker(
    ...
    override fun doWork(): Result {
        ...
        val notification = NotificationCompat.Builder(applicationContext, "pitcrew_races")

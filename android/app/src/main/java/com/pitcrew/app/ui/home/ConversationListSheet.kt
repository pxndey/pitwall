...
import com.pitcrew.app.data.remote.model.ConversationOut
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = onCreate) {
                    Icon(Icons.Default.Add, contentDescription = "New Chat", tint = PitCrewRed)
                }
            }
                    ...
                    items(conversations) { convo ->
                        ...
                        Card(
                            ...
                            colors = CardDefaults.cardColors(
                                containerColor = if (isActive) PitCrewRed.copy(alpha = 0.2f) else PitCrewBackground,
                            ),
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    Text(
                                        text = convo.title,
                                        color = if (isActive) PitCrewRed else Color.White,

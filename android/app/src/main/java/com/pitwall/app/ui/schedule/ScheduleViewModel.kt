...
data class ScheduleUiState(
    ...
    // Race context chat
    val contextChatMessages: List<com.pitwall.app.ui.home.Message> = emptyList(),
...
class ScheduleViewModel @Inject constructor(
    ...
    fun sendContextMessage(message: String, circuitContext: String) {
        val userMsg = com.pitwall.app.ui.home.Message(role = "user", content = message)
        ...
        viewModelScope.launch {
            chatRepository.sendMessage(
                ...
                onSuccess = { response ->
                    val assistantMsg = com.pitwall.app.ui.home.Message(role = "assistant", content = response.reply)
                    _uiState.value = _uiState.value.copy(
